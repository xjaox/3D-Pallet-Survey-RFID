...
//400 - tamanho Cena
var sizePalletY = (400 - objCreateBox.sizeBox).toString();
...
function CreateBox() {
    ...
    if (objCreateBox.idBox == "1") {
        sizePalletY = (400 - objCreateBox.sizeBox).toString();
        objCreateBox.translateY = sizePalletY;
    }
...
function AddColor(tag, valor) {
    $(function () {
        ...
        var id = ("#" + tag + " div");
        var cor = "bgColorBrack";
        switch (valor) {
            case "-1": { cor = "bgColorRed" };
                break;
            case "0": { cor = "bgColorOrange" };
                break;
            case "1": { cor = "bgColorGreen" };
                break;
        }

        $(id).addClass("Enable").addClass(cor);
    });
}
...
$(function () {
    $("#btAdcionarCaixa").click(function () {
        ...
        if (button == false) {
            //document.getElementById("btAdcionarCaixa").disabled = true;
...
//        $(function () {
//            setInterval(function () { Readtag(); }, 1000);
//        });        
